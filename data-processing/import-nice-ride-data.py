...
for row in reader:
  if row_count > 0:
      if row[0]:
        ...
        # birth_date date,
        db.execute("INSERT INTO rentals (rental_id, account_number, subscriber_id, start_date, start_station, start_terminal, end_date, end_station, end_terminal, duration_seconds, bike_id, gender, zip, subscription_type_a, subscription_type_b, birth_date) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
